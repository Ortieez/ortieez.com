...
export function Left(props: Props) {
    return (
        <div className="parent h-full">
            ...
            <div className={"h-full w-full div2 flex flex-col items-center justify-center border-l-1"}>
                <button className={"cursor-pointer"} onClick={() => go(DivEnum.LEFT, DivEnum.CENTER)}><ArrowBigRight strokeWidth={1} /></button>
            </div>
