...
export function Right(props: Props) {
    return (
        <div className="parent h-full">
            ...
            <div className={"h-full w-full div4 flex flex-col items-center justify-center border-r-1"}>
                <button className={"cursor-pointer"} onClick={() => go(DivEnum.RIGHT, DivEnum.CENTER)}><ArrowBigLeft  strokeWidth={1}/></button>
            </div>

            <div className={"h-full  w-full bg-pink-50  div5 flex flex-col items-center justify-center"}>
                text
            </div>
